...
const RenderRazorpay = ({
    ...
    const handlePayment = async (status, orderDetails = {}) => {
        await axios.post(`http://localhost:8001/apis/razorpay_callback/`,
            {
                status,
                orderDetails,
            });
    ...
    const options = {
        ...
        modal: {
            confirm_close: false, // this is set to true, if we want confirmation when clicked on cross button.
